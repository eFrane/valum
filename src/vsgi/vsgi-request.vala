...
namespace VSGI {
	...
	public class Request : Object {
		...
		/**
		 * Steal the connection underlying this request.
		 *
		 * Once called, the request should not be manipulated.
		 */
		[Version (since = "0.4")]
		public virtual IOStream steal_connection () {
			return (owned) _connection;
		}
